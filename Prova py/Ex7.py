...
if (n1 < n2) and (n1 < n3):
    print("O {} é o primeiro listado e menor número".format(n1))
elif (n2 < n1) and (n2 < n3):
    print("O {} é o segundo listado e menor número".format(n2))
elif (n3 < n1) and (n3 < n2):
    print("O {} é o terceiro listado e menor número".format(n3))
